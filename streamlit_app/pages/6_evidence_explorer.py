...
render_topbar("Evidence Explorer")
# ── Page header ────────────────────────────────────────────────────────────────
...
""", unsafe_allow_html=True)
    ...
    # ── Section 2.5: Search Queries (Agent 1 Generated) ──────────────────────
    search_queries = result.get("queries", [])
    if search_queries:
        st.markdown("""
        <div class="ms-section-header">
            <div class="ms-section-title">Search Strategy</div>
            <div class="ms-section-subtitle">PubMed queries generated by Agent 1</div>
        </div>
        """, unsafe_allow_html=True)
            ...
            <div style="background:var(--bg-surface); border:1px solid var(--border);
                ...
                <div style="display:flex; align-items:center; gap:12px; margin-bottom:8px;">
                    <div style="font-family:var(--font-mono); font-size:11px; font-weight:600;
                                ...
                                padding:4px 10px; border-radius:5px; letter-spacing:0.8px;">
                        QUERY {i}
                    </div>
                </div>
